...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost/bigbluebox/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Images options.
	imgSRC: './img/originals/**/*', // Source folder of images which should be optimized and watched. You can also specify types e.g. raw/**.{png,jpg,gif} in the glob.
	...
	// Translation options.
	textDomain: 'bigbluebox', // Your textdomain here.
	translationFile: 'bigbluebox.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'bigbluebox', // Package name.
