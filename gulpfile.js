// START Editing Project Variables.
      ...
      // Project related.
const project                 = 'BigBlueBox'; // Project Name.
      projectURL              = 'http://localhost/bigbluebox/'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
      productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

      // Translation related.
      text_domain             = 'bigbluebox'; // Your textdomain here.
      translationFile         = 'bigbluebox.pot'; // Name of the transalation file.
      ...
      // Images related.
      imagesSRC               = './img/originals/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
