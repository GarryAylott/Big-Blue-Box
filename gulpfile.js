...
// Project related.
var project                 = 'Big Blue Box Theme'; // Project Name.
...
var translationFile         = 'languages/bigbluebox.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'BigBlueBox'; // Package name.
var bugReport               = 'https://AhmadAwais.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'Garry Aylott <garry@bigblueboxpodcast.co.uk>'; // Last translator Email ID.
var team                    = 'Big Blue Box Podcast <garry@bigblueboxpodcast.co.uk>'; // Team's Email ID.
...
// Images related.
var imagesSRC               = './assets/images/originals/**/*.{png,jpg,gif,svg}'; // Source folder of images which should be optimized.
